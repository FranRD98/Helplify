...
require_once('Config/db.php');
    ...
    try {
        ...
        $queryTickets = "select id, titulo, estado, prioridad, idcategoria, idusuario, created_at from Tickets ORDER BY id desc";
        ...
        while ($row = $queryTickets->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<td>" . htmlspecialchars($row['idcategoria']) . "</td>";
            ...
            echo '<a href="#" class="edit-icon" onclick="editarCategoria(' . htmlspecialchars($row['id']) . ', \'' . htmlspecialchars($row['nombre']) . '\')">
            ...
            echo '<a href="Controllers/Categorias/eliminarCategoria.php?id=' . htmlspecialchars($row['id']) . '" class="delete-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24" fill="none">
